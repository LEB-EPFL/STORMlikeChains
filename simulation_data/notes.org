...
* [#C] rw_2015-8-7
 ...
 toc = time.time()
 print('Total processing time: %f' % (toc - tic))
* [#A] simData_HelaL_WT_2015-8-14
  Primary WT HeLa L dataset for the paper, using the correct genomic length
  distribution and localization precision.
