...
experimentDatasetName = os.getcwd() + '/experimental_distrs/Original_Data_S_dataset_RgTrans'

# List of NumPyDB database names without the file suffix.
dbNames = [os.getcwd() + '/simulation_data/rw_2015-2-2_HelaS_WT']

outputFName = 'likelihood_data/llh_Original_Data_S_dataset_RgTrans2015-2-2.npy'
